    ...
    <main className="min-h-screen bg-gradient-to-br from-purple-300 via-pink-300 to-blue-400 flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <div className="w-full md:w-1/2 text-center">
          ...
          <button
            className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-blue-500 hover:to-purple-500 text-white font-semibold h-[40px] w-[140px] my-1 rounded-full shadow-lg transition duration-300"
            onClick={addLink}
          >
            Add Link
          </button>
          ...
          <button
            ...
            className="disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r from-purple-500 to-blue-500 hover:from-blue-500 hover:to-purple-500 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300"
          ...
          {successfullyCreated && (
            <Link href={`/${linkHandle}`}>
              <button className="my-4 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-blue-500 hover:to-purple-500 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300">
                View your LinkPage
              </button>
            </Link>
          )}
